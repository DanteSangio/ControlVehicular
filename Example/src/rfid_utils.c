...
void setupRFID(MFRC522Ptr_t* mfrc522) {
	*mfrc522 = MFRC522_Init();
	...
	// // Set pins as// GPIO
	//Puerto 0 Pin 4 SS Puerto 0 pin 5 RST

	Chip_IOCON_PinMux (LPC_IOCON , RFIDRST , IOCON_MODE_INACT , IOCON_FUNC0);
	Chip_IOCON_PinMux (LPC_IOCON , RFIDSS , IOCON_MODE_INACT , IOCON_FUNC0);
